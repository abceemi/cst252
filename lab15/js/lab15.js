...
//Create a class for vehicles called Vehicle, including make, model, year, color, and extras.
class Vehicle {
  ...
  info() {
    return this.color + "" + this.year + " " + this.make + " " + this.model + "with" + this.extras + "called" + this.name"; //neatly returns a string with all that information
  }
}
